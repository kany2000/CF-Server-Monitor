...
const translations = reactive({
  en: {
    ...
    trafficReportEnabled: 'Enable traffic reports',
    trafficReportTime: 'Traffic report time',
    trafficReportTip: 'Uses lightweight JSON baselines in the notification timezone. Daily reports run every day, weekly reports on Monday, and monthly reports on the first day. Missing previous-period data is shown in the notification.',
  ...
  zh: {
    ...
    trafficReportEnabled: '开启流量报告',
    trafficReportTime: '流量报告时间',
    trafficReportTip: '按通知时区维护轻量 JSON 基线；日报每天发送，周报在周一发送，月报在每月 1 日发送。缺少上一周期基线时会在通知中说明暂无数据。',
